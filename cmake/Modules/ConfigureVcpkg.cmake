...
IF(WIN32)
    set(MESHSDK_USE_VCPKG_DEFAULT ON)
ELSE()
    set(MESHSDK_USE_VCPKG_DEFAULT OFF)
ENDIF()
option(MESHSDK_USE_VCPKG "Use the vcpkg package manager" ${MESHSDK_USE_VCPKG_DEFAULT})
IF(MESHSDK_USE_VCPKG)
    ...
    IF(NOT DEFINED VCPKG_TARGET_TRIPLET)
        ...
        set(VCPKG_TARGET_TRIPLET "x64-windows-meshsdk" CACHE STRING "vcpkg target triplet")
    ENDIF()
    message(STATUS "Using vcpkg triplet: ${VCPKG_TARGET_TRIPLET}")
ELSEIF(MESHSDK_USE_VCPKG_DEFAULT)
