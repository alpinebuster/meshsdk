...
ELSE() # if APPLE
  ...
  IF( CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 17 ) # ethier AppleClang or Clang
    set(MESHSDK_COMMON_C_CXX_FLAGS "${MESHSDK_COMMON_C_CXX_FLAGS} -fno-assume-unique-vtables")
  ENDIF()
ENDIF()
...
IF(MSVC)
  ...
  # !! NOTE: Sync this list with `common.props` !!
  set(MESHSDK_COMMON_C_CXX_FLAGS "${MESHSDK_COMMON_C_CXX_FLAGS} /wd4061 /wd4250 /wd4324 /wd4365 /wd4371 /wd4388 /wd4435 /wd4514 /wd4582 /wd4583 /wd4599 /wd4605 /wd4623 /wd4625 /wd4626 /wd4668 /wd4686 /wd4710 /wd4711 /wd4820 /wd4865 /wd4866 /wd4868 /wd5026 /wd5027 /wd5031 /wd5039 /wd5045 /wd5104 /wd5105 /wd5219 /wd5243 /wd5246 /wd5262 /wd5264 /wd26451")
ELSE()
  ...
  # command line option '-fvisibility-inlines-hidden' is valid for C++/ObjC++ but not for C, so we cannot put it in MESHSDK_COMMON_C_CXX_FLAGS
  ...
  IF(CMAKE_CXX_COMPILER_ID STREQUAL "Clang" OR CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang")
    ...
    if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 22)
      ...
      set(MESHSDK_COMMON_C_CXX_FLAGS "${MESHSDK_COMMON_C_CXX_FLAGS} -Wno-c2y-extensions")
    endif()
  ENDIF()
ENDIF()
...
#   use GCC 12 for MeshSDK, so the resulting MeshSDK library is probably incompatible with GCC 11 anyway, so we don't care about this bug there.
