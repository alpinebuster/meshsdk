...
# Build `libpybind11nonlimitedapi_meshsdk_X.Y.so` shims automatically, for all installed Python versions?
...
mrcuda_CSubLibraryOutputProject := MeshSDKC2Cuda
...
$(foreach x,$(MODULES),\
	$(call var,meshsdk_InputProjects += $($x_InputProjects))\
	$(call var,meshsdk_ExtraMrbindFlags += $($x_ExtraMrbindFlags))\
	$(call var,meshsdk__InputDirs += $($x__InputDirs))\
	$(call var,meshsdk__InputFiles += $($x__InputFiles))\
)
$(eval $(call module_snippet_parse,meshsdk))
endif
...
endef
$(eval $(call module_snippet_generate_c,meshsdk))
endif # $(TARGET) == c
