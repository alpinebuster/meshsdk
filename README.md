...
**Multi-Language Support.** Written in C++ with bindings for C, C#, Python, and JavaScript/TypeScript, it can be integrated easily into AI pipelines and workflows.
